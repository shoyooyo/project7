docker build -t shoyooyo/project7client:latest -t shoyooyo/project7client:$SHA -f ./client/Dockerfile ./client
docker build -t shoyooyo/project7server:latest -t shoyooyo/project7server:$SHA -f ./server/Dockerfile ./server
docker build -t shoyooyo/project7worker:latest -t shoyooyo/project7worker:$SHA -f ./worker/Dockerfile ./worker
